...
export const program_id = new PublicKey(
  "FQkajEMvJ61JDaW41cNQaUnHTK1Kv5CVe4bJXJXWF3JQ"
)

const RPC_ENDPOINT_URL = "https://devnet.genesysgo.net/"
...
export async function createTokenMint() {
  ...
  let mint = await createMint(connection, wallet, mintAuth[0], null, 6)
